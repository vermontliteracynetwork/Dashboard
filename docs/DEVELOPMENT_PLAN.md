...
- **Playground — meme/personality-quiz/mini-game gallery.** From an early Playground-overhaul brainstorm, referencing the Kinzoo messaging app's kid-facing marketplace as a model: "a gallery where i can add videos and images for the kids to look through... fun things like memes, mini games, and silly personality quizzes." Distinct from the native games (Platformer, Scratch Arcade) already shipped — this is lighter, teacher-curated casual content, confirmed not built.
