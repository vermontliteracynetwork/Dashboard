...
const rowToStudent = (r: Row): Student => ({
  ...
  ownedHomeItemIds: r.owned_home_item_ids ?? [],
  ...
  vehicleSoundEnabled: r.vehicle_sound_enabled ?? true,
...
const studentToRow = (s: Student): Row => ({
  ...
  owned_home_item_ids: s.ownedHomeItemIds,
  ...
  vehicle_sound_enabled: s.vehicleSoundEnabled ?? true,
...
const STUDENT_COLUMNS: Record<keyof Student, string> = {
  ...
  ownedHomeItemIds: 'owned_home_item_ids',
  ...
  vehicleSoundEnabled: 'vehicle_sound_enabled',
