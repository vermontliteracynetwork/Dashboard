...
export async function fetchAll(): Promise<HydratedState> {
  const [
    ...
    literacyFocusSetsRes, worldObjectsRes, focusesRes, wallSegmentsRes, studentFeedbackRes, quizStrugglesRes,
  ] = await Promise.all([
