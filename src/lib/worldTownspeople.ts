...
export const TOWNSPEOPLE: Record<string, Townsperson> = {
  'amb-1': {
    ...
    dialogues: [
      ...
      [
        { npc: "Oh, perfect, one more for you!", options: ["Hi Miller!", "Go ahead."] },
        { npc: "Why did the bagel stop rolling down the hill?", options: ["No idea.", "Why?", "Did it get stuck?"] },
        {
          npc: "It ran out of dough!",
          jokeId: 'miller-out-of-dough',
          jokeBookEntry: { npcName: 'Miller', setup: 'Why did the bagel stop rolling?', punchline: 'It ran out of dough!', explain: 'Bagels are made of dough, and "dough" is also slang for money. Running out of either one stops you in your tracks.' },
          options: ["Ha, dough!", "Good one, Miller."],
        },
        { npc: "I've always got more dough where that came from. See you around!" },
      ],
      [
        { npc: "Hey, good to see you! How's your day going?", options: ["Pretty good.", "Kind of a long one.", "Can't complain."] },
        { npc: "That's about the range I get too. Anything good happen yet today?", options: ["Not yet.", "Talked to a few neighbors.", "Not really."] },
        { npc: "Well, the day's not over. Thanks for stopping to chat.", options: ["Sure thing, Miller.", "See you later."] },
        { npc: "Take care, I've got bread to check on!" },
      ],
      [
        { npc: "Hey! I heard you've been trying new things on your task list lately.", options: ["Yeah, some of them.", "A few, I guess.", "Trying to."] },
        { npc: "That takes guts, trying something new. Most folks just stick to what they know.", options: ["Thanks, Miller.", "It's been okay so far."] },
        { npc: "Keep at it, you'll be an old pro before you know it.", options: ["I will!"] },
        { npc: "See you around town!" },
      ],
    ],
  },
  'amb-2': {
    ...
    dialogues: [
      ...
      [
        { npc: "Oh, one more knock knock for you!", options: ["Hi Rosa!", "Okay, go for it."] },
        { npc: "Knock knock.", options: ["Who's there?"] },
        { npc: "Cargo.", options: ["Cargo who?"] },
        {
          npc: "Car go beep beep! Get it? Cargo is stuff in a truck, and car go sounds just the same.",
          jokeId: 'rosa-cargo',
          jokeBookEntry: { npcName: 'Rosa', setup: "Knock knock. Who's there? Cargo.", punchline: "Car go beep beep!", explain: 'Cargo is stuff carried in a truck, and "car go" sounds exactly the same said out loud.' },
          options: ["Ha, car go!", "Good one, Rosa."],
        },
        { npc: "That one's fun to say fast. See you around!" },
      ],
      [
        { npc: "Hi again! How's everything going today?", options: ["Pretty good.", "Kind of a busy one.", "Doing okay."] },
        { npc: "Glad to hear it. Anything fun planned for later?", options: ["Not sure yet.", "Just hanging out.", "Maybe."] },
        { npc: "Sounds nice either way. Good talking with you.", options: ["You too, Rosa.", "See you later."] },
        { npc: "Take care out there!" },
      ],
      [
        { npc: "Hey, I noticed you've been saying hi to just about everyone in town lately.", options: ["I try to.", "I'm working on it.", "Yeah, I guess so."] },
        { npc: "That's a real kindness, and it doesn't go unnoticed around here.", options: ["Thanks, Rosa.", "That's nice to hear."] },
        { npc: "Keep it up, this town's better for it.", options: ["I will!"] },
        { npc: "See you around!" },
      ],
    ],
  },
  'amb-3': {
    ...
    dialogues: [
      ...
      [
        { npc: "Hey! One more pond joke for you.", options: ["Hi Jasper!", "Let's hear it."] },
        { npc: "Why did the fish blush?", options: ["No idea.", "Why?", "Was it embarrassed?"] },
        {
          npc: "Because it saw the ocean's bottom!",
          jokeId: 'jasper-fish-blush',
          jokeBookEntry: { npcName: 'Jasper', setup: 'Why did the fish blush?', punchline: "Because it saw the ocean's bottom!", explain: 'The ocean floor is called its "bottom," which is also a silly word for the part you sit on. That double meaning is why the fish is embarrassed.' },
          options: ["Ha, bottom!", "Good one, Jasper."],
        },
        { npc: "I crack myself up out here. See you later!" },
      ],
      [
        { npc: "Hey there! How's your day treating you?", options: ["Pretty good.", "Long day.", "Can't complain."] },
        { npc: "Fair enough. Seen anything interesting by the pond lately?", options: ["Not yet.", "Just the usual ducks.", "Haven't checked today."] },
        { npc: "Worth a look sometime. Thanks for stopping by.", options: ["Sure thing, Jasper.", "See you later."] },
        { npc: "Enjoy your walk, take care!" },
      ],
      [
        { npc: "Hey, I noticed you've been slowing down to actually look around town lately.", options: ["Yeah, I have been.", "Trying to notice more.", "I guess so."] },
        { npc: "That's a good habit. Most folks rush right past the good stuff.", options: ["Thanks, Jasper.", "I hadn't thought of it that way."] },
        { npc: "Keep noticing things, it adds up.", options: ["I will!"] },
        { npc: "Catch you by the pond!" },
      ],
    ],
  },
};
