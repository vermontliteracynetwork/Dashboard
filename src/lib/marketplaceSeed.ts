...
export const STARTER_MARKETPLACE_ITEMS: Omit<MarketplaceItem, 'createdAt'>[] = [
  ...
  // Colors
  { id: 'color-black', kind: 'color', name: 'Black', icon: '🎨', price: 0, category: 'Colors', tags: [], colorHex: '#1f1147' },
  { id: 'color-blue', kind: 'color', name: 'Blue', icon: '🎨', price: 0, category: 'Colors', tags: [], colorHex: '#3b82f6' },
  { id: 'color-red', kind: 'color', name: 'Red', icon: '🎨', price: 200, category: 'Colors', tags: [], colorHex: '#e63946' },
  { id: 'color-green', kind: 'color', name: 'Green', icon: '🎨', price: 200, category: 'Colors', tags: [], colorHex: '#2fae5d' },
  { id: 'color-purple', kind: 'color', name: 'Purple', icon: '🎨', price: 200, category: 'Colors', tags: [], colorHex: '#7c3aed' },
  { id: 'color-orange', kind: 'color', name: 'Orange', icon: '🎨', price: 200, category: 'Colors', tags: [], colorHex: '#fb923c' },
  { id: 'color-pink', kind: 'color', name: 'Pink', icon: '🎨', price: 200, category: 'Colors', tags: [], colorHex: '#ec4899' },
  { id: 'color-teal', kind: 'color', name: 'Teal', icon: '🎨', price: 200, category: 'Colors', tags: [], colorHex: '#14b8a6' },
  { id: 'color-gold', kind: 'color', name: 'Gold', icon: '🎨', price: 400, category: 'Colors', tags: [], colorHex: '#d4a017' },
  { id: 'color-rainbow', kind: 'color', name: 'Rainbow', icon: '🎨', price: 800, category: 'Colors', tags: ['fancy'], colorHex: 'rainbow' },
  // Voices
